...
public class WomanPunishAction extends CrudActionSupport<WomanPunish> {
	...
	public String delete() throws Exception {
		...
		try {
			...
			monitorLogManager.saveMonitorLog("删除行政处罚信息", System.currentTimeMillis()-t1_, id!=null?1:StringUtils.split(ids, ",").length);
	...
	public String save() throws Exception {
		...
		try{
			...
			monitorLogManager.saveMonitorLog((id == null?"增加":"修改")+"行政处罚信息", System.currentTimeMillis()-t1_, 1);
