 ...
 * 
 * $Id: Struts2Utils.java 1211 2010-09-10 16:20:45Z shally $
 */
package com.jeysan.modules.utils.web.struts2;
...
import com.jeysan.modules.utils.web.ServletUtils;
...
public class Struts2Utils {
	...
	public static <T> T formJson(String jsonString, Class<T> clazz) throws Exception{   
        ...
        try {   
            ...
            throw new Exception("parse json string error:" + jsonString, e);   
        }   
    } 
    ...
    public static String toJson(Object object) throws Exception{  
        ...
        try {   
        	...
        	throw new Exception("write to json string error:" + object, e);   
        }   
    }   
