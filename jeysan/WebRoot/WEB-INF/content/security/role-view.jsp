...
<div class="page">
	<div class="pageContent">
		<form class="pageForm">
			<div class="pageFormContent" layoutH="56" style="width:400px;float:left">
																													<p>
					<label>角色编码：</label>
					<input name="roleCode" readonly="readonly" type="text" size="30" value="${roleCode}"/>
					</p>
																														<p>
					<label>角色名称：</label>
					<input name="roleName" readonly="readonly" type="text" size="30" value="${roleName}"/>
					</p>
																														<p>
					<label>是否启用：</label>
					<input name="roleEnable" readonly="readonly" type="text" size="30" value="<tags:js.yes.no.getValue value="${roleEnable}"/>"/>
					</p>
...
<div style="float:left;width:260px;margin-left:20px">
	<div><h2 class="contentTitle" style="width:200px">已分配资源</h2></div>
