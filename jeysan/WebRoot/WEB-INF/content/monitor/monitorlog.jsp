				...
				<tr target="sid_xxx" rel="${a.id}">
					...
					<td>${b.index+1}</td>
						...
						<div style="width: 75px;">
							<a class="btnView" href="${ctx}/monitor/monitorlog!view.action?id=${a.id}" target="navTab" title="查看用户操作日志信息" rel="monitorLog-view"></a>
							<a class="btnEdit" href="${ctx}/monitor/monitorlog!input.action?id=${a.id}" target="navTab" title="修改用户操作日志信息" rel="monitorLog-update"></a>
							<a class="btnDel" href="${ctx}/monitor/monitorlog!delete.action?id=${a.id}&result4Json.navTabId=nav_monitorlogmanage" target="ajaxTodo" title="确定要删除吗？"></a>
						</div>
					</td>
				</tr>
				</c:forEach>
