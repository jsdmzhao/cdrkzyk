...
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" action="${ctx}/daily/rule.action" method="post">
		<div class="searchBar">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="${ctx}/daily/rule!input.action" target="navTab" rel="rule-input" title="添加fhp_rule"><span>添加</span></a></li>
				<li><a class="delete" href="${ctx}/daily/rule!delete.action?ids={sid_xxx}&result4Json.navTabId=nav_rulemanage" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			...
			<thead>
				<tr>
					...
					<th width="30" align="center">序号</th>
																																			<th width="80" orderField="typeh" class="orderFlag">类别</th>
																														<th width="80" orderField="title" class="orderFlag">标题</th>
																														<th width="80" orderField="sendEmployeeId" class="orderFlag">发布人</th>
				...
				<tr target="sid_xxx" rel="${a.id}">
					...
					<td>${b.index+1}</td>
						...
						<div style="width: 75px;">
							<a class="btnView" href="${ctx}/daily/rule!view.action?id=${a.id}" target="navTab" title="查看fhp_rule信息" rel="rule-view"></a>
							<a class="btnEdit" href="${ctx}/daily/rule!input.action?id=${a.id}" target="navTab" title="修改fhp_rule信息" rel="rule-update"></a>
							<a class="btnDel" href="${ctx}/daily/rule!delete.action?id=${a.id}&result4Json.navTabId=nav_rulemanage" target="ajaxTodo" title="确定要删除吗？"></a>
						</div>
					</td>
				</tr>
				</c:forEach>
