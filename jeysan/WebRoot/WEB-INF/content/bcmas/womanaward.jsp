...
<tags:js.pager action="${ctx}/bcmas/womanaward.action">
	<input type="hidden" name="filter_EQI_id" value="${param['filter_EQI_id']}" />
</tags:js.pager>
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" action="${ctx}/bcmas/womanaward.action" method="post">
		<div class="searchBar">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="${ctx}/bcmas/womanaward!input.action" target="navTab" rel="womanAward-input" title="添加奖励信息"><span>添加</span></a></li>
			...
			<thead>
				<tr>
					...
					<th width="30" align="center">序号</th>
																														...
																														<th width="80" orderField="awardDate" class="orderFlag">奖励日期</th>
																														<th width="80" orderField="awardContent" class="orderFlag">奖励内容</th>
																														<th width="80" orderField="agent" class="orderFlag">奖励经办人</th>
																														<th width="80" orderField="typeh" class="orderFlag">奖励类别</th>
				...
				<tr target="sid_xxx" rel="${a.id}">
					...
					<td>${b.index+1}</td>
						...
						<div style="width: 75px;">
							...
							<a class="btnDel" href="${ctx}/bcmas/womanaward!delete.action?id=${a.id}&result4Json.navTabId=nav_womanawardmanage" target="ajaxTodo" title="确定要删除吗？"></a>
						</div>
					</td>
				</tr>
				</c:forEach>
