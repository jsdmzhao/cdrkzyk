		...
		<form class="pageForm">
			<div class="pageFormContent" layoutH="56">
					...
					<input name="womanId" readonly="readonly" type="text" size="30" value="${womanId}"/>
																														...
																														<p>
					<label>处罚日期：</label>
					<input name="punishDate" readonly="readonly" type="text" size="30" value="<fmt:formatDate value="${punishDate}" pattern="yyyy-MM-dd"/>"/>
					</p>
																														<p>
					<label>处罚原因：</label>
					<input name="punishCause" readonly="readonly" type="text" size="30" value="${punishCause}"/>
					</p>
																														<p>
					<label>处罚经办人：</label>
