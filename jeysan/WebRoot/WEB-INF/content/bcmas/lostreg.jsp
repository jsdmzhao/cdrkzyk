...
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);"
			action="${ctx}/bcmas/lostreg.action" method="post">
	<input type="hidden" name="filter_EQS_fertileWoman.area" value="${param['filter_EQS_fertileWoman.area']}" />
			<div class="searchBar">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li>
					<a class="delete"
						href="${ctx}/bcmas/lostreg!delete.action?ids={sid_xxx}&result4Json.navTabId=nav_lostregmanage"
					...
					<tr target="sid_xxx" rel="${a.id}">
						...
						<td>
							<div style="width: 25px;">
								<a class="btnEdit"
									href="${ctx}/bcmas/lostreg!input.action?id=${a.id}"
									target="navTab" title="登记或修改双查漏查信息"
									rel="lostreg-update"></a>
							</div>
						</td>
						<td>
							<div style="width: 50px;">
								<a class="btnView"
									href="${ctx}/bcmas/lostreg!view.action?id=${a.id}"
									target="navTab" title="查看双查漏查信息"
									rel="lostreg-view"></a>
								<a class="btnDel"
									href="${ctx}/bcmas/lostreg!delete.action?id=${a.id}&result4Json.navTabId=nav_lostregmanage"
