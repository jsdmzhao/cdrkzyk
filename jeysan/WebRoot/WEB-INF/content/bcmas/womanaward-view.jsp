		...
		<form class="pageForm">
			<div class="pageFormContent" layoutH="56">
					...
					<input name="womanId" readonly="readonly" type="text" size="30" value="${womanId}"/>
																														...
																														<p>
					<label>奖励日期：</label>
					<input name="awardDate" readonly="readonly" type="text" size="30" value="<fmt:formatDate value="${awardDate}" pattern="yyyy-MM-dd"/>"/>
					</p>
																														<p>
					<label>奖励内容：</label>
					<input name="awardContent" readonly="readonly" type="text" size="30" value="${awardContent}"/>
					</p>
																														<p>
					<label>奖励经办人：</label>
