...
<tr>
    ...
    <td height="30" rowspan="4" align="center" valign="middle" class="In1-td-rightbottom">总人口数</td>
    <td height="30" rowspan="4" align="center" valign="middle" class="In1-td-rightbottom">平均人口数</td>
    <td height="30" colspan="20" align="center" valign="middle" class="In1-td-rightbottom">出生</td>
    <td height="30" colspan="2" align="center" valign="middle" class="In1-td-rightbottom">死亡</td>
    <td height="30" colspan="2" align="center" valign="middle" class="In1-td-rightbottom">自然增长</td>
    <td height="30" colspan="3" align="center" valign="middle" class="In1-td-bottom">女性初婚</td>
  </tr>
  <tr>
    <td height="30" colspan="6" align="center" valign="middle" class="In1-td-rightbottom">一孩</td>
    <td height="30" colspan="6" align="center" valign="middle" class="In1-td-rightbottom">二孩</td>
    <td height="30" colspan="5" align="center" valign="middle" class="In1-td-rightbottom">三孩及以上</td>
    <td height="30" rowspan="3" align="center" valign="middle" class="In1-td-rightbottom">合计</td>
    <td height="30" rowspan="3" align="center" valign="middle" class="In1-td-rightbottom">出生率(%)</td>
    <td height="30" rowspan="3" align="center" valign="middle" class="In1-td-rightbottom">政策生育率(%)</td>
    <td height="30" rowspan="3" align="center" valign="middle" class="In1-td-rightbottom">人数</td>
    <td height="30" rowspan="3" align="center" valign="middle" class="In1-td-rightbottom">死亡率(%)</td>
    <td height="30" rowspan="3" align="center" valign="middle" class="In1-td-rightbottom">人数</td>
    <td height="30" rowspan="3" align="center" valign="middle" class="In1-td-rightbottom">自然增长率(%)</td>
    <td height="30" rowspan="3" align="center" valign="middle" class="In1-td-rightbottom">人数</td>
    <td height="30" colspan="2" align="center" valign="middle" class="In1-td-bottom">其中</td>
  </tr>
  <tr>
    ...
    <td height="30" colspan="2" align="center" valign="middle" class="In1-td-rightbottom">其中</td>
    <td height="30" colspan="2" align="center" valign="middle" class="In1-td-rightbottom">其中政策内</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">人数</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">%</td>
    <td height="30" colspan="2" align="center" valign="middle" class="In1-td-rightbottom">其中</td>
    <td height="30" colspan="2" align="center" valign="middle" class="In1-td-rightbottom">其中政策内</td>
    ...
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">%</td>
    <td height="30" colspan="2" align="center" valign="middle" class="In1-td-rightbottom">其中</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">其中政策内</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">不足20岁人数</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-bottom">23周岁以上人数</td>
  </tr>
  <tr>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">男</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">女</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">男</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">女</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">男</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">女</td>
