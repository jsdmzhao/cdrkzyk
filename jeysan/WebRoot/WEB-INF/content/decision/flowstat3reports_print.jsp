...
<tr>
    <td height="30" rowspan="3" align="center" valign="middle" class="In1-td-rightbottom">序号</td>
    <td height="30" rowspan="3" align="center" valign="middle" class="In1-td-rightbottom">单位</td>
    <td height="30" rowspan="3" align="center" valign="middle" class="In1-td-rightbottom">已婚育龄妇女人数</td>
    <td height="30" colspan="12" align="center" valign="middle" class="In1-td-rightbottom">本期计划生育手术</td>
    <td height="30" colspan="10" align="center" valign="middle" class="In1-td-rightbottom">现有已婚育龄夫妇落实节育措施</td>
    <td height="30" colspan="3" align="center" valign="middle" class="In1-td-rightbottom">领取独生子女证</td>
    <td height="30" rowspan="3" align="center" valign="middle" class="In1-td-bottom">取环(花)</td>
  </tr>
  <tr>
    ...
    <td height="30" colspan="3" align="center" valign="middle" class="In1-td-rightbottom">采取补救措施</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">皮下埋植</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">合计</td>
    ...
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">放环(花)</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">服(注)药</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">避孕套</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">外用药</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">皮下埋植</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">其它</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">合计</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">节育率</td>
    <td height="30" colspan="2" align="center" valign="middle" class="In1-td-rightbottom">人数</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">领证率</td>
  </tr>
  <tr>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">小计</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">男结扎</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">女结扎</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">其中二孩结扎</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">其中纯二女扎</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">小计</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">其中一孩放环</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">小计</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">补救措施一</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">补救措施二</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">本期</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">期末</td>
  </tr>
