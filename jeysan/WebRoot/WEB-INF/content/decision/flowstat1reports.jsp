...
<div class="page">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li>
					<a class="icon" href="javascript:<c:if test="${(not empty param.filter_GED_startDate) && (not empty param.filter_LED_endDate)}">JS_print3('${param.filter_GED_startDate}至${param.filter_LED_endDate}计划生育情况统计表')</c:if>"><span>打印或导出</span>
					</a>
				</li>
			</ul>
		</div>
