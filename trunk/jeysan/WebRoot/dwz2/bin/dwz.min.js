...
var $input=$(element);
var pattern=$input.attr('pattern')||'yyyy-MM-dd';
...
break;
case 'date':
html='<input type="text" name="'+fieldName+'" class="date '+field.fieldClass+'" pattern="'+field.patternDate+'" size="'+field.size+'"/>'+'<a class="inputDateButton" href="javascript:void(0)">选择</a>';
break;
default:
