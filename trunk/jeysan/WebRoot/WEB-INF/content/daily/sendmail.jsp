...
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" action="${ctx}/daily/sendmail.action" method="post">
		<div class="searchBar">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="${ctx}/daily/sendmail!input.action" target="navTab" rel="sendMail-input" title="添加fhp_send_mail"><span>添加</span></a></li>
				<li><a class="delete" href="${ctx}/daily/sendmail!delete.action?ids={sid_xxx}&result4Json.navTabId=nav_sendmailmanage" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
				...
				<tr target="sid_xxx" rel="${a.id}">
					...
					<td>${b.index+1}</td>
						...
						<div style="width: 75px;">
							<a class="btnView" href="${ctx}/daily/sendmail!view.action?id=${a.id}" target="navTab" title="查看fhp_send_mail信息" rel="sendMail-view"></a>
							<a class="btnEdit" href="${ctx}/daily/sendmail!input.action?id=${a.id}" target="navTab" title="修改fhp_send_mail信息" rel="sendMail-update"></a>
							<a class="btnDel" href="${ctx}/daily/sendmail!delete.action?id=${a.id}&result4Json.navTabId=nav_sendmailmanage" target="ajaxTodo" title="确定要删除吗？"></a>
						</div>
					</td>
				</tr>
				</c:forEach>
