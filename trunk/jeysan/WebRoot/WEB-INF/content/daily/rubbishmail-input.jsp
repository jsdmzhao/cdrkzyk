...
<div class="page">
	<div class="pageContent">
		<form method="post" action="${ctx}/daily/rubbishmail!save.action" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone4Update);">
			<input type="hidden" name="id" value="${id}"/><!-- 
			<input type="hidden" name="result4Json.callbackType" value="closeCurrent"/> -->
			<input type="hidden" name="result4Json.navTabId" value="nav_rubbishmailmanage"/>
			<div class="pageFormContent" layoutH="56">
					...
					<input name="sendEmployeeId" class="digits  required" type="text" size="30" value="${sendEmployeeId}"/>
																													...
																													<p>
					<label>收件人：</label>
					<input name="receiveEmployeeIds"  class="required" maxlength="1000"    type="text" size="30" value="${receiveEmployeeIds}"  alt="请输入收件人" />
					</p>
																													<p>
					<label>主题：</label>
					...
					<input name="isRead"    type="text" size="30" value="${isRead}" />
																													...
																													<p>
					<label>来源：</label>
					<input name="source"    type="text" size="30" value="${source}" />
					</p>
																	</div>
			<div class="formBar">
				<ul>
