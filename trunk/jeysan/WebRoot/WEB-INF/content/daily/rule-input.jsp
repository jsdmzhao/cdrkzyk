...
<div class="page">
	<div class="pageContent">
		<form method="post" action="${ctx}/daily/rule!save.action" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone4Update);">
			<input type="hidden" name="id" value="${id}"/><!-- 
			<input type="hidden" name="result4Json.callbackType" value="closeCurrent"/> -->
			<input type="hidden" name="result4Json.navTabId" value="nav_rulemanage"/>
			<div class="pageFormContent" layoutH="56">
					...
					<input name="typeh" class="digits" type="text" size="30" value="${typeh}"/>
																													...
																													<p>
					<label>标题：</label>
					<input name="title"  class="required" maxlength="200"    type="text" size="30" value="${title}"  alt="请输入标题" />
					</p>
																													<p>
					<label>发布人：</label>
