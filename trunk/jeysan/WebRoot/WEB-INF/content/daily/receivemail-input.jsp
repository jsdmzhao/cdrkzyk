...
<div class="page">
	<div class="pageContent">
		<form method="post" action="${ctx}/daily/receivemail!save.action"
			...
			<div class="pageFormContent" layoutH="56">
				...
				<p>
					...
					<input name="receiveEmployeeIds" class="required" maxlength="10"
						type="text" size="30" value="${receiveEmployeeIds}" alt="请输入收件人" />
				</p>
				<p>
					<label>
						主题：
					...
					<input name="title" class="required" maxlength="200" type="text"
						size="30" value="${title}" alt="请输入主题" />
				</p>
				<p>
					<label>
						附件：
					</label>
					<input name="attachment" type="text" size="30"
						value="${attachment}" />
				</p>
				<p>
					<label>
				...
				<p>
					...
					<input name="status" class="required" maxlength="1" type="text"
						size="30" value="${status}" alt="请输入状态" />
				</p>
				<p>
					<label>
						父邮件：
					</label>
					<input name="parMailId" class="digits" type="text" size="30"
						value="${parMailId}" />
				</p>
				<p>
					<label>
