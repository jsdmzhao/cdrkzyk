		...
		<form class="pageForm">
			<div class="pageFormContent" layoutH="56">
					...
					<input name="nameh" readonly="readonly" type="text" size="30" value="${nameh}"/>
																														...
																														<p>
					<label>固话：</label>
					<input name="telPhone" readonly="readonly" type="text" size="30" value="${telPhone}"/>
					</p>
																														<p>
					<label>移动电话：</label>
					<input name="mobilePhone" readonly="readonly" type="text" size="30" value="${mobilePhone}"/>
					</p>
																														<p>
					<label>常用邮箱：</label>
					<input name="email" readonly="readonly" type="text" size="30" value="${email}"/>
					</p>
																														<p>
					<label>单位：</label>
					...
					<input name="address" readonly="readonly" type="text" size="30" value="${address}"/>
																														...
																														<p>
					<label>分组：</label>
					<input name="grouph" readonly="readonly" type="text" size="30" value="${grouph}"/>
					</p>
																														<p>
					<label>备注：</label>
