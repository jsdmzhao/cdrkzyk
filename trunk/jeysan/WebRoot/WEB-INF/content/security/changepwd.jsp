...
<div class="page">
	...
	<form method="post" action="${ctx}/security/user!chanegpwd.action" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone)">
		<input type="hidden" name="id" value="${_js_user.id}"/>
