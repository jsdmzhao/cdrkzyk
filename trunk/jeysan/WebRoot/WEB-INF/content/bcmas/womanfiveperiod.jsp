...
<tags:js.pager action="${ctx}/bcmas/womanfiveperiod.action">
	<input type="hidden" name="filter_EQI_id" value="${param['filter_EQI_id']}" />
</tags:js.pager>
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" action="${ctx}/bcmas/womanfiveperiod.action" method="post">
		<div class="searchBar">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="${ctx}/bcmas/womanfiveperiod!input.action" target="navTab" rel="womanFivePeriod-input" title="添加五期教育"><span>添加</span></a></li>
			...
			<thead>
				<tr>
					...
					<th width="30" align="center">序号</th>
																														...
																														<th width="80" orderField="eduType" class="orderFlag">教育类型</th>
																														<th width="80" orderField="eduDate" class="orderFlag">教育日期</th>
																														<th width="80" orderField="eduAddress" class="orderFlag">教育地点</th>
				...
				<tr target="sid_xxx" rel="${a.id}">
					...
					<td>${b.index+1}</td>
						...
						<div style="width: 75px;">
							...
							<a class="btnDel" href="${ctx}/bcmas/womanfiveperiod!delete.action?id=${a.id}&result4Json.navTabId=nav_womanfiveperiodmanage" target="ajaxTodo" title="确定要删除吗？"></a>
						</div>
					</td>
				</tr>
				</c:forEach>
