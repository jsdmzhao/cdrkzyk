	...
	<form class="pageForm">
		<div class="pageFormContent" layoutH="56">
			...
			<p>
				...
				<input name="spouseMarryStatus" readonly="readonly" type="text"
			...
			<p>
				...
				<input name="firstMarryDate" readonly="readonly" type="text"
					size="30"
			...
			<p>
				...
				<input name="getGrzDate" readonly="readonly" type="text" size="30"
			...
			<p>
				...
				<input name="planChild2Cause" readonly="readonly" type="text"
					size="30" value="${planChild2Cause}" />
			</p>
			<p>
				<label>
					安排二孩日期：
				</label>
				<input name="planChild2Date" readonly="readonly" type="text"
					size="30"
			...
			<p>
				...
				<input name="planBear2Cause" readonly="readonly" type="text"
					size="30" value="${planBear2Cause}" />
			</p>
			<p>
				<label>
					安排再生日期：
				</label>
				<input name="planBear2Date" readonly="readonly" type="text"
					size="30"
			...
			<p>
				...
				<input name="getLdzType" readonly="readonly" type="text" size="30"
					value="${getLdzType}" />
			</p>
			<p>
				<label>
				...
				<input name="getLdzDate" readonly="readonly" type="text" size="30"
			...
			<p>
				...
				<input name="cancelType" readonly="readonly" type="text" size="30"
					value="${cancelType}" />
			</p>
			<p>
				<label>
			...
			<p>
				...
				<input name="certDate" readonly="readonly" type="text" size="30"
