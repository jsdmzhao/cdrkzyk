...
<div class="page">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li>
					<a class="icon" href="javascript:<c:if test="${(not empty param.start) && (not empty param.end)}">JS_print2('${param.start}至${param.end}查环查孕情况汇总表(三)')</c:if>"><span>打印或导出</span>
					</a>
				</li>
			</ul>
		</div>
