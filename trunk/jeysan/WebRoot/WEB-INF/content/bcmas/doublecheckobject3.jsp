...
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);"
			action="${ctx}/bcmas/doublecheckobject!list3.action" method="post">
	<input type="hidden" name="filter_EQS_fertileWoman.area" value="${param['filter_EQS_fertileWoman.area']}" />
			<div class="searchBar">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li>
					<a class="delete"
						href="${ctx}/bcmas/doublecheckobject!delete.action?ids={sid_xxx}&result4Json.navTabId=nav_doubleCheckObject3manage"
				...
				<li>
					<a class="icon" href="javascript:JS_print2('${param.filter_EQI_year}年第${param.filter_EQI_seq}轮${param.status==0?'未':'已'}处理双查漏查信息')"><span>打印或导出</span>
					</a>
				</li>
			</ul>
		</div>
		<table class="table" width="150%" layouth="165">
			<thead>
				<tr>
					...
					<th width="80" orderField="ldwContent" class="orderFlag">
						处理措施
					</th>
					<th width="80" orderField="ldwDate" class="orderFlag" htype="date">
						处理时间
					</th>
			...
			<tbody>
				<c:forEach var="a" items="${page.result}" varStatus="b">
					<tr target="sid_xxx" rel="${a.id}">
						...
						<td>
							<fmt:formatDate value="${a.ldwDate}" pattern="yyyy-MM-dd" />
						</td>
						<td>
						...
						<td>
							<div style="width: 25px;">
								<a class="btnEdit"
									href="${ctx}/bcmas/doublecheckobject!input3.action?id=${a.id}"
									target="navTab" title="登记或修改双查漏查信息"
									rel="doubleCheckObject3-update"></a>
							</div>
						</td>
						<td>
