...
<div class="page">
	<div class="pageContent">
		<form method="post"
			action="${ctx}/bcmas/doublecheck!save.action"
			...
			<div class="pageFormContent" layoutH="56">
				...
				<p style="width:98%">
					...
					<select class="required" name="year" id="year" onchange="navTab.reload('${ctx}/bcmas/doublecheck!input.action?year='+this.value)">
				...
				<p style="width:98%">
					...
					<select class="required" name="total" id="total" onchange="addCount()">
				...
				<div style="width:600px;float:left;border:1px solid #ccc;margin-top:40px;padding:10px" id="detail_div">
					...
					<c:forEach items="${dcs}" var="a" varStatus="b">
						<tr>
							<td width="120" height="30">第${a.seq}轮</td><td width="25" align="center">从</td>
...
function addCount(){
	...
	if(v == null || v == '')
		return;
	var start = $('#start',$box).val();
	var $detail_table = $('#detail_table',$box);
