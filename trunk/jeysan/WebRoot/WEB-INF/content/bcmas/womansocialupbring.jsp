...
<tags:js.pager action="${ctx}/bcmas/womansocialupbring.action">
	<input type="hidden" name="filter_EQI_id" value="${param['filter_EQI_id']}" />
</tags:js.pager>
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" action="${ctx}/bcmas/womansocialupbring.action" method="post">
		<div class="searchBar">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="${ctx}/bcmas/womansocialupbring!input.action" target="navTab" rel="womanSocialUpbring-input" title="添加社会抚养费"><span>添加</span></a></li>
			...
			<thead>
				<tr>
					...
					<th width="30" align="center">序号</th>
																														...
																														<th width="80" orderField="cause" class="orderFlag">征收原因</th>
																														<th width="80" orderField="outDate" class="orderFlag">政策外生育日期</th>
																														<th width="80" orderField="totalMoney" class="orderFlag">应交金额</th>
																														<th width="80" orderField="isInstallment" class="orderFlag">是否分期</th>
																														<th width="80" orderField="endDate" class="orderFlag">缴交期限</th>
				...
				<tr target="sid_xxx" rel="${a.id}">
					...
					<td>${b.index+1}</td>
						...
						<div style="width: 75px;">
							...
							<a class="btnDel" href="${ctx}/bcmas/womansocialupbring!delete.action?id=${a.id}&result4Json.navTabId=nav_womansocialupbringmanage" target="ajaxTodo" title="确定要删除吗？"></a>
						</div>
					</td>
				</tr>
				</c:forEach>
