...
<tags:js.pager action="${ctx}/bcmas/womanbearassurance.action">
	<input type="hidden" name="filter_EQI_id" value="${param['filter_EQI_id']}" />
</tags:js.pager>
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" action="${ctx}/bcmas/womanbearassurance.action" method="post">
		<div class="searchBar">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="${ctx}/bcmas/womanbearassurance!input.action" target="navTab" rel="womanBearAssurance-input" title="添加计划生育保险"><span>添加</span></a></li>
			...
			<thead>
				<tr>
					...
					<th width="30" align="center">序号</th>
																														...
																														<th width="80" orderField="typeh" class="orderFlag">投保类型</th>
				...
				<tr target="sid_xxx" rel="${a.id}">
					...
					<td>${b.index+1}</td>
						...
						<div style="width: 75px;">
							...
							<a class="btnDel" href="${ctx}/bcmas/womanbearassurance!delete.action?id=${a.id}&result4Json.navTabId=nav_womanbearassurancemanage" target="ajaxTodo" title="确定要删除吗？"></a>
						</div>
					</td>
				</tr>
				</c:forEach>
