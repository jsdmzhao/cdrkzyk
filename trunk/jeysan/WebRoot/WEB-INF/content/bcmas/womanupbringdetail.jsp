...
<tags:js.pager action="${ctx}/bcmas/womanupbringdetail.action">
	<input type="hidden" name="filter_EQI_id" value="${param['filter_EQI_id']}" />
</tags:js.pager>
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" action="${ctx}/bcmas/womanupbringdetail.action" method="post">
		<div class="searchBar">
				...
				<tr target="sid_xxx" rel="${a.id}">
					...
					<td>${b.index+1}</td>
						...
						<div style="width: 75px;">
							...
							<a class="btnDel" href="${ctx}/bcmas/womanupbringdetail!delete.action?id=${a.id}&result4Json.navTabId=nav_womanupbringdetailmanage" target="ajaxTodo" title="确定要删除吗？"></a>
						</div>
					</td>
				</tr>
				</c:forEach>
