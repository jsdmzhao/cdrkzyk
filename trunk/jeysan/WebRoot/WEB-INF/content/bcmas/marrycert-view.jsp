		...
		<form class="pageForm">
			<div class="pageFormContent" layoutH="56">
					...
					<input name="tel" readonly="readonly" type="text" size="30" value="${tel}"/>
																														...
																														<p>
					<label>有效期：</label>
					<input name="validPeriod" readonly="readonly" type="text" size="30" value="<fmt:formatDate value="${validPeriod}" pattern="yyyy-MM-dd"/>"/>
					</p>
																														<p>
					<label>经办人：</label>
					<input name="agent" readonly="readonly" type="text" size="30" value="${agent}"/>
																														...
																														<p>
					<label>结婚时间：</label>
					<input name="marryDate" readonly="readonly" type="text" size="30" value="<fmt:formatDate value="${marryDate}" pattern="yyyy-MM-dd"/>"/>
					</p>
																														<p>
					<label>所在乡（镇、街道）计生办电话：</label>
					<input name="fpoTel1" readonly="readonly" type="text" size="30" value="${fpoTel1}"/>
					</p>
																														<p>
					<label>配偶所在乡（镇、街道）计生办电话：</label>
					<input name="fpoTel2" readonly="readonly" type="text" size="30" value="${fpoTel2}"/>
					</p>
																														<p>
					<label>发证时已有子女数（男）：</label>
					<input name="beforeBoyCount" readonly="readonly" type="text" size="30" value="${beforeBoyCount}"/>
					</p>
																														<p>
					<label>发证时已有子女数（女）：</label>
					<input name="beforeGirlCount" readonly="readonly" type="text" size="30" value="${beforeGirlCount}"/>
					</p>
																														<p>
					<label>发证后生育子女数（男）：</label>
					<input name="afterBoyCount" readonly="readonly" type="text" size="30" value="${afterBoyCount}"/>
					</p>
																														<p>
					<label>发证后生育子女数（女）：</label>
					<input name="afterGirlCount" readonly="readonly" type="text" size="30" value="${afterGirlCount}"/>
					</p>
																														<p>
					<label>照片：</label>
