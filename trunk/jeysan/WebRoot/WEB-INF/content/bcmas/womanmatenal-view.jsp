		...
		<form class="pageForm">
			<div class="pageFormContent" layoutH="56">
					...
					<input name="womanId" readonly="readonly" type="text" size="30" value="${womanId}"/>
																														...
																														<p>
					<label>怀孕政策属性：</label>
					<input name="conceptPolicy" readonly="readonly" type="text" size="30" value="${conceptPolicy}"/>
					</p>
																														<p>
					<label>怀孕日期：</label>
					<input name="conceptDate" readonly="readonly" type="text" size="30" value="<fmt:formatDate value="${conceptDate}" pattern="yyyy-MM-dd"/>"/>
					</p>
																														<p>
					<label>怀孕原因：</label>
					<input name="conceptCause" readonly="readonly" type="text" size="30" value="${conceptCause}"/>
					</p>
																														<p>
					<label>怀孕结果：</label>
					<input name="conceptResult" readonly="readonly" type="text" size="30" value="${conceptResult}"/>
					</p>
																														<p>
					<label>预产期：</label>
					...
					<input name="hospitalAddress" readonly="readonly" type="text" size="30" value="${hospitalAddress}"/>
																														...
																														<p>
					<label>孕产结果：</label>
					<input name="matenalResult" readonly="readonly" type="text" size="30" value="${matenalResult}"/>
					</p>
																														<p>
					<label>手术日期：</label>
