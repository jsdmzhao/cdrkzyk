...
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);"
			action="${ctx}/pmas/person.action" method="post">
			<div class="searchBar">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li>
					<a class="add" href="${ctx}/pmas/person!input.action"
						target="navTab" rel="person-input" title="添加人员"><span>添加</span>
					</a>
				</li>
				<li>
					<a class="delete"
						href="${ctx}/pmas/person!delete.action?ids={sid_xxx}&result4Json.navTabId=nav_personmanage"
					...
					<tr target="sid_xxx" rel="${a.id}">
						...
						<td>
							<div style="width: 75px;">
								...
								<a class="btnEdit"
									href="${ctx}/pmas/person!input.action?id=${a.id}"
									target="navTab" title="修改人员信息" rel="person-update"></a>
								<a class="btnDel"
									href="${ctx}/pmas/person!delete.action?id=${a.id}&result4Json.navTabId=nav_personmanage"
						...
						<td>
							<div style="width: 50px;">
								...
								<a class="btnEdit"
									href="${ctx}/pmas/spouse!input.action?personId=${a.id}"
									target="navTab" title="管理配偶信息" rel="spouse-update"></a>
							</div>
						</td>
						<td>
							<div style="width: 50px;">
								...
								<a class="btnEdit"
									href="${ctx}/pmas/womanchildren.action?filter_EQL_person.id=${a.id}&personId=${a.id}&from=person"
									target="navTab" title="管理子女信息" rel="nav_womanchildrenmanage"></a>
							</div>
						</td>
						<td>
							<div style="width: 25px;">
								<c:if test="${a.cancelType==672||a.cancelType==673}">
									<a class="btnDel"
										href="${ctx}/pmas/person!precancel.action?id=${a.id}&type=0"
										target="navTab" title="人员注销" rel="person-update"></a>
								</c:if>
								<c:if test="${a.cancelType!=672&&a.cancelType!=673}">
									<a class="btnSelect"
										href="${ctx}/pmas/person!cancel.action?id=${a.id}&type=1&result4Json.navTabId=nav_personmanage"
