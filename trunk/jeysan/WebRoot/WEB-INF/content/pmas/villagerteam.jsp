...
<div class="page">
	<div class="pageHeader">
		<form onsubmit="return navTabSearch(this);" action="${ctx}/pmas/villagerteam.action" method="post">
		<div class="searchBar">
	...
	<div class="pageContent">
		<div class="panelBar">
			<ul class="toolBar">
				<li><a class="add" href="${ctx}/pmas/villagerteam!input.action" target="navTab" rel="villagerTeam-input" title="添加村民小组"><span>添加</span></a></li>
				<li><a class="delete" href="${ctx}/pmas/villagerteam!delete.action?ids={sid_xxx}&result4Json.navTabId=nav_villagerteammanage" target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
				...
				<tr target="sid_xxx" rel="${a.id}">
					...
					<td>${b.index+1}</td>
						...
						<div style="width: 75px;">
							<a class="btnView" href="${ctx}/pmas/villagerteam!view.action?id=${a.id}" target="navTab" title="查看村民小组信息" rel="villagerTeam-view"></a>
							<a class="btnEdit" href="${ctx}/pmas/villagerteam!input.action?id=${a.id}" target="navTab" title="修改村民小组信息" rel="villagerTeam-update"></a>
							<a class="btnDel" href="${ctx}/pmas/villagerteam!delete.action?id=${a.id}&result4Json.navTabId=nav_villagerteammanage" target="ajaxTodo" title="确定要删除吗？"></a>
						</div>
					</td>
				</tr>
				</c:forEach>
