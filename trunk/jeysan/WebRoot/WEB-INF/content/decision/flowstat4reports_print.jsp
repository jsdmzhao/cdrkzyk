...
<div style="margin:auto;">
  ...
  <tr>
    ...
    <td height="30" colspan="8" align="center" valign="middle" class="In1-td-rightbottom">一孩夫妇</td>
    <td height="30" colspan="10" align="center" valign="middle" class="In1-td-rightbottom">二孩夫妇</td>
    <td height="30" colspan="8" align="center" valign="middle" class="In1-td-bottom">三孩及以上夫妇</td>
  </tr>
  <tr>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">人数</td>
    <td height="30" colspan="7" align="center" valign="middle" class="In1-td-rightbottom">其中</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">人数</td>
    <td height="30" colspan="2" align="center" valign="middle" class="In1-td-rightbottom">其中纯女户</td>
    <td height="30" colspan="7" align="center" valign="middle" class="In1-td-rightbottom">其中</td>
    <td height="30" rowspan="2" align="center" valign="middle" class="In1-td-rightbottom">人数</td>
    <td height="30" colspan="7" align="center" valign="middle" class="In1-td-bottom">其中</td>
  </tr>
  <tr>
    ...
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">放环(花)</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">避孕药具</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">皮下埋植</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">其它</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">合计</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">人数</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">其中结扎</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">男结扎</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">女结扎</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">放环(花)</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">避孕药具</td>
   ...
   <td height="30" align="center" valign="middle" class="In1-td-rightbottom">男结扎</td>
    ...
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">皮下埋植</td>
    <td height="30" align="center" valign="middle" class="In1-td-rightbottom">其它</td>
    <td height="30" align="center" valign="middle" class="In1-td-bottom">合计</td>
  </tr>
